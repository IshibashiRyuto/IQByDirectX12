...
std::shared_ptr<VertexBuffer> VertexBuffer::Create(std::shared_ptr<Device> device, void * pVertices, size_t vertexSize, size_t vertexCount, const std::wstring & bufferName)
{
	HRESULT result;
...
void VertexBuffer::WriteVertexBuffer(void * data, size_t dataSize, size_t dataCount, unsigned int dataIndexOffset)
{
	void* pBuf;
